  ...
  return (
    <div className="flex flex-1 flex-col gap-4 p-4">
      ...
      <div className="space-y-2">
        ...
        <p className="text-sm text-muted-foreground">
          Configura alertas para recibir notificaciones de nuevos empleos que
          coincidan con tus intereses.
        </p>
            ...
            <CardContent className="p-4 flex gap-4">
              ...
              <div className="bg-muted/50 rounded-lg p-4">
                <div className="flex items-start gap-3">
                  ...
                  />
                  <p className="text-sm text-muted-foreground">
                    <span className="font-medium">Consejo:</span> Crea múltiples
                    alertas con diferentes palabras clave para no perderte
                    oportunidades.
                  </p>
                </div>
              </div>
