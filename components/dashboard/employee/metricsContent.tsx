...
import { TrendingUp01Icon, TrendingDown01Icon } from "@hugeicons/core-free-icons"
          ...
          <Card key={kpi.title}>
            ...
            <CardContent>
              ...
              {kpi.trend && (
                ...
                >
                  {kpi.trendPositive ? (
                    <HugeiconsIcon icon={TrendingUp01Icon} className="h-3 w-3" />
                  ) : (
                    <HugeiconsIcon icon={TrendingDown01Icon} className="h-3 w-3" />
                  )}
                  {kpi.trend}
                </p>
              )}
