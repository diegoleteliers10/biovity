...
import { GraduationCap, Briefcase, TrendingUp, Users, ArrowRight } from "lucide-react"
...
export function ForStudents() {
  ...
  useGSAP(
    () => {
      ...
      // Animación del contenido derecho (card)
      gsap.fromTo(
        rightRef.current,
        {
          opacity: 0,
      ...
      const benefitCards = benefitsRef.current?.querySelectorAll("div") || []
      gsap.fromTo(
        benefitCards,
        {
          opacity: 0,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div ref={leftRef}>
            ...
            <button
              type="button"
              className="inline-flex items-center px-8 py-4 bg-gray-900 hover:bg-gray-800 text-white rounded-full font-medium transition-all duration-300 hover:-translate-y-1 shadow-lg hover:shadow-xl"
            >
