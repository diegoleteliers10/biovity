    ...
    <section className="relative min-h-svh sm:h-svh w-full flex items-center justify-center overflow-hidden contain-paint">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full z-10 pt-20 md:pt-24">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div
            style={{
              animation: "hero-entrance-stats 0.5s cubic-bezier(0.23, 1, 0.32, 1) 0.36s both",
            }}
            ...
            {HERO_STATS_EMPRESAS.map((stat, index) => {
              ...
              return (
                <div
                  key={stat.label}
                  style={{
                    animation: `hero-entrance-stat-item 0.5s cubic-bezier(0.23, 1, 0.32, 1) ${0.36 + index * 0.08}s both`,
                  }}
