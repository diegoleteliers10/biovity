      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            ...
            mercado laboral de ciencias. Vimos que profesionales y estudiantes altamente capacitados luchaban por
            encontrar oportunidades, mientras empresas en biotecnología, química y farmacia enfrentaban
            dificultades para encontrar talento especializado, y mantener un seguimiento de inicio a fin de sus procesos de selección.
          </motion.p>
        </motion.div>
          ...
          {VALUES_DATA.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-2 font-rubik">{item.title}</h3>
