        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-12 max-w-3xl">
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <p>
                Antofagasta, con su fuerte presencia minera y aplicaciones biotecnológicas,
                lidera los sueldos promedio. La Región Metropolitana, centro de servicios,
                farmacéuticas y tecnología, ocupa el segundo lugar, mientras que las regiones
                agroindustriales presentan rangos más moderados pero estables.
              </p>
            </div>
          </div>
              ...
              >
                ...
                >
                  {REGION_CHART_DATA.map((_entry, index) => (
                    <Cell key={`cell-${index}`} fill={REGION_CHART_COLORS[index % REGION_CHART_COLORS.length]} />
                  ))}
                </Bar>
              </BarChart>
            </ChartContainer>
