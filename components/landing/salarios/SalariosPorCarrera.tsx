        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-12 max-w-3xl">
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              <p>
                El nivel de experiencia es uno de los factores más determinantes en las
                remuneraciones del sector de biociencias. Nuestro análisis revela diferencias
                significativas entre perfiles Junior (0-2 años de experiencia) y Senior (5+ años),
                con variaciones que pueden superar el 100% en algunas carreras.
              </p>
              <p>
                Las carreras con mayor componente técnico y de análisis de datos, como
                Bioinformática e Ingeniería Civil Química, muestran las mayores brechas
                salariales, reflejando la alta demanda de experiencia especializada en estos campos.
              </p>
            </div>
          </div>
            ...
            <div className="lg:col-span-2">
              <Card className="border-0 shadow-lg flex flex-col h-full">
                <CardHeader>
                  ...
                  <CardDescription>
                    Valores en miles de pesos chilenos (CLP)
                  </CardDescription>
                </CardHeader>
                  ...
                  <div className="grid grid-cols-[auto_1fr] gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-600">
                        Mayor sueldo senior: $3.2M
                      </p>
                    </div>
                  </div>
                  <div className="grid grid-cols-[auto_1fr] gap-3">
                    <ArrowUpRight className="w-5 h-5 text-green-600 mt-0.5 shrink-0" />
                    <div>
