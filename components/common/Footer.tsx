...
const FOOTER_SECTIONS = [
  {
    ...
    links: [
      ...
      { label: "Alertas de Empleo", href: "/jobs" },
      { label: "Consejos de Carrera", href: "/career-tips" },
      { label: "Salarios", href: "/salaries" },
      { label: "Compartir Salario", href: "/share-salary" },
  ...
  },
  {
    title: "Para Empresas",
    links: [
      { label: "Publicar Empleo", href: "/dashboard/offers" },
      { label: "Buscar Candidatos", href: "/dashboard/talent" },
      { label: "Planes y Precios", href: "/plans" },
      { label: "Herramientas de Reclutamiento", href: "/recruiting" },
      { label: "Contactar Ventas", href: "/companies#contacto" },
    ],
  },
  {
    ...
    links: [
      ...
      { label: "Guía de Marca", href: "/brand" },
