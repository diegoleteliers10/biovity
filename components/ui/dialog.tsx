      ...
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            className="absolute top-2 right-2 inline-flex size-8 shrink-0 items-center justify-center rounded-md hover:bg-muted/50 active:scale-[0.97] transition-all duration-150 cursor-pointer"
          >
