...
/* eslint-disable react-doctor/prefer-dynamic-import -- lazy loading would require significant refactor */
...
const ChartStyle = ({ id, config }: { id: string; config: ChartConfig }) => {
  ...
  return (
    <style {...(process.env.NODE_ENV === "development" ? {} : { suppressHydrationWarning: true })}>
...
const TooltipLabel = React.memo(function TooltipLabel({
  ...
  label: unknown
  labelFormatter?: (value: unknown, payload: object[]) => React.ReactNode
  payload: unknown[]
  ...
  const [item] = payload as Array<{ dataKey?: string | number; name?: string | number }>
  ...
  if (labelFormatter) {
    return (
      <div className={cn("font-medium", labelClassName)}>
        {labelFormatter(value, payload as object[])}
      </div>
    )
  }
...
const getConfigLabelKey = (payload: unknown, payloadPayload: unknown, key: string): string => {
  if (
