...
/* eslint-disable react-doctor/no-explicit-any */
/* biome-ignore-all lint/suspicious/noExplicitAny: type checking utilities intentionally use any for component type detection */
