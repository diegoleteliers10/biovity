...
export default function RegisterPage() {
  const [activeTab, setActiveTab] = useState<"organización" | "persona">(
    "persona"
  );
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  id="name"
                  type="text"
                  placeholder={activeTab === "persona" ? "Tu nombre completo" : "Tu nombre completo"}
                  value={formData.name}
            ...
            {activeTab === "organización" && (
              <>
                ...
                <div className="space-y-2">
                  ...
                  {errors.organizationWebsite && <p className="text-sm text-red-500">{errors.organizationWebsite}</p>}
                </div>
              </>
            )}
